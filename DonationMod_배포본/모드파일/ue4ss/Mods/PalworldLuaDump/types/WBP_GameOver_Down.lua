...
---@field ['Is Partner Skill Revive'] boolean
---@field OpenChatActionName FPalDataTableRowName_UIInputAction
local UWBP_GameOver_Down_C = {}

---@param Widget UWidget
function UWBP_GameOver_Down_C:GetDesiredFocusTargetInternal(Widget) end
function UWBP_GameOver_Down_C:OnCompleteChat() end
function UWBP_GameOver_Down_C:OnRequestOpenChat() end
function UWBP_GameOver_Down_C:CencelPartnerSkillReive() end
---@return UWidget
...
UWBP_GameOver_Down_C['Unregister Action'] = function(self, ...) end
