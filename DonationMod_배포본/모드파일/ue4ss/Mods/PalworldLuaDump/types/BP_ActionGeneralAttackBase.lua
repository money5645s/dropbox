...
local UBP_ActionGeneralAttackBase_C = {}

---@param Stop boolean
function UBP_ActionGeneralAttackBase_C:ShouldBeginStopMovement(Stop) end
---@param OwnerActor AActor
UBP_ActionGeneralAttackBase_C['Get Attack Owner'] = function(self, OwnerActor) end
...
UBP_ActionGeneralAttackBase_C['Shorten Animation Time when Pal Ridden'] = function(self, ...) end
...
UBP_ActionGeneralAttackBase_C['Set Disable Movement'] = function(self, Enable) end
...
UBP_ActionGeneralAttackBase_C['Movement Enable'] = function(self, ...) end
