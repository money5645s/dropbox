...
AStemSpline_BP_C['[SubStem]-DoCheckSegment'] = function(self, StartLocation, relativeNormal, currentSubLevel) end
...
AStemSpline_BP_C['(Bridge)_TraceTowardsDirection'] = function(self, StartLocation, relativeNormal, Direction, hitSomething, LastLocation, HitLocation, HitNormal, traceDirection) end
