...
local UBP_VisualEffect_CameraBase_C = {}
...
UBP_VisualEffect_CameraBase_C['カスタムイベント_FadeIIn'] = function(self, ...) end
UBP_VisualEffect_CameraBase_C['カスタムイベント_FadeOut'] = function(self, ...) end
