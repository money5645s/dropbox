...
UBP_PalIncidentRandom_C['Spawn NPCs'] = function(self, SpawnDataList) end
---@param SpawnDataList UDataTable
UBP_PalIncidentRandom_C['Spawn Monsters'] = function(self, SpawnDataList) end
UBP_PalIncidentRandom_C['Spawn Characters'] = function(self, ...) end
function UBP_PalIncidentRandom_C:OnGroupCreated() end
---@param RequestParams TArray<FPalRandomIncidentGroupRequestParameter>
function UBP_PalIncidentRandom_C:CreateGroupRequestParams(RequestParams) end
---@param Result boolean
---@param Data FPalRandomIncidentSettings
UBP_PalIncidentRandom_C['Get Setting Table Row'] = function(self, Result, Data) end
---@param IncidentSpawner APalRandomIncidentSpawnerBase
UBP_PalIncidentRandom_C['Get Incident Spawner'] = function(self, IncidentSpawner) end
