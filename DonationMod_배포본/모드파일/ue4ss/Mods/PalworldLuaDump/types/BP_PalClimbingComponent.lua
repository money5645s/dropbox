...
local UBP_PalClimbingComponent_C = {}

---@param Disable boolean
function UBP_PalClimbingComponent_C:IsDisableClimbingArea(Disable) end
...
UBP_PalClimbingComponent_C['Cancel Ray Check'] = function(self, ...) end
...
UBP_PalClimbingComponent_C['OnMovementModeChangedDelegate_イベント_0'] = function(self, Component, prevMode, newMode, PrevCustomMode, NewCustomMode) end
function UBP_PalClimbingComponent_C:DelayCanClimbing() end
---@param DeadInfo FPalDeadInfo
UBP_PalClimbingComponent_C['カスタムイベント_OnDead'] = function(self, DeadInfo) end
