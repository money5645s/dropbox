...
local UBP_PalBiomeEffectController_C = {}

---@param DeltaSeconds float
function UBP_PalBiomeEffectController_C:ReceiveTick(DeltaSeconds) end
---@param Biome_Type EPalBiomeType
UBP_PalBiomeEffectController_C['On Biome Enter'] = function(self, Biome_Type) end
UBP_PalBiomeEffectController_C['On Biome Exit'] = function(self, ...) end
