...
---@field NotStartTimer double
---@field IsStartAble boolean
local UBP_AIAction_invader_March_C = {}

UBP_AIAction_invader_March_C['Warp Move'] = function(self, ...) end
---@param DeltaTime double
function UBP_AIAction_invader_March_C:CountupNotStartTimer(DeltaTime) end
---@param AICon APalAIController
UBP_AIAction_invader_March_C['Get Controller Ref'] = function(self, AICon) end
