...
---@field CurrentBallRotator FRotator
...
---@field CurveVelocity FVector2D
---@field StartVelocityRotation FRotator
---@field CurveInterval double
---@field CurveIntervalTimer double
---@field CurveID EPalCurveBall
---@field ['Forward Velocity'] double
---@field InitCurveVelocity FVector2D
---@field bIsCriticalCapture boolean
local ABP_PalSphere_ThrowObject_C = {}

function ABP_PalSphere_ThrowObject_C:FillOverlap() end
---@param OverlappedComponent UPrimitiveComponent
---@param bCritical boolean
function ABP_PalSphere_ThrowObject_C:IsCritical(OverlappedComponent, bCritical) end
function ABP_PalSphere_ThrowObject_C:SetupCurveID() end
ABP_PalSphere_ThrowObject_C['Setup Horming'] = function(self, ...) end
---@param CurveID EPalCurveBall
function ABP_PalSphere_ThrowObject_C:SetCurveParameter(CurveID) end
---@param DeltaTime double
function ABP_PalSphere_ThrowObject_C:UpdateCurve(DeltaTime) end
...
ABP_PalSphere_ThrowObject_C['Play Sound Bounce'] = function(self, HitResult) end
...
ABP_PalSphere_ThrowObject_C['Capture Start Process After Delay'] = function(self, Body, TargetActor, SneakAttack) end
...
function ABP_PalSphere_ThrowObject_C:UserConstructionScript() end
...
function ABP_PalSphere_ThrowObject_C:OnOverlap(Actor, PrimitiveComponent) end
function ABP_PalSphere_ThrowObject_C:UpdateHoming() end
