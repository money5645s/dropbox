...
---@field WBP_OptionSettings_MenuButton_S_EULA UWBP_OptionSettings_MenuButton_S_C
---@field WBP_OptionSettings_MenuButton_S_Form UWBP_OptionSettings_MenuButton_S_C
---@field WBP_OptionSettings_MenuButton_S_Mod UWBP_OptionSettings_MenuButton_S_C
...
local UWBP_OptionSettings_C = {}

function UWBP_OptionSettings_C:ResetScroll() end
function UWBP_OptionSettings_C:TryRedirectToDiscordLink() end
---@param bFromTitle boolean
function UWBP_OptionSettings_C:IsOpenFromTitle(bFromTitle) end
---@param Param UPalHUDDispatchParameterBase
function UWBP_OptionSettings_C:OnClosedModSettings(Param) end
---@param Bind boolean
UWBP_OptionSettings_C['Set Tab Action'] = function(self, Bind) end
---@return UWidget
...
function UWBP_OptionSettings_C:OnSetup() end
function UWBP_OptionSettings_C:Destruct() end
function UWBP_OptionSettings_C:BndEvt__WBP_OptionSettings_WBP_OptionSettings_MenuButton_S_Mod_K2Node_ComponentBoundEvent_8_OnClicked__DelegateSignature() end
function UWBP_OptionSettings_C:BndEvt__WBP_OptionSettings_WBP_OptionSettings_MenuButton_S_EULA_K2Node_ComponentBoundEvent_9_OnClicked__DelegateSignature() end
function UWBP_OptionSettings_C:BndEvt__WBP_OptionSettings_WBP_OptionSettings_MenuButton_S_Form_K2Node_ComponentBoundEvent_10_OnClicked__DelegateSignature() end
