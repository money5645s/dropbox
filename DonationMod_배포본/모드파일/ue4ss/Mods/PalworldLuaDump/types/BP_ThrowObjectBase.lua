...
---@field Const_Effect_Scale float
---@field Const_Effect_ColorShock FLinearColor
---@field Const_Effect_ColorThrow FLinearColor
---@field Const_Effect_ColorThrow2 FLinearColor
local ABP_ThrowObjectBase_C = {}

---@param Niagara UNiagaraComponent
function ABP_ThrowObjectBase_C:SetEffectParam(Niagara) end
function ABP_ThrowObjectBase_C:CacheDefaultGravity() end
ABP_ThrowObjectBase_C['Play Throw Sound'] = function(self, ...) end
