...
UBP_PalSupplyIncident_C['Spawn NPCs'] = function(self, SpawnDataList) end
---@param SpawnDataList UDataTable
UBP_PalSupplyIncident_C['Spawn Monsters'] = function(self, SpawnDataList) end
UBP_PalSupplyIncident_C['Spawn Characters'] = function(self, ...) end
function UBP_PalSupplyIncident_C:OnGroupCreated() end
---@param RequestParams TArray<FPalRandomIncidentGroupRequestParameter>
function UBP_PalSupplyIncident_C:CreateGroupRequestParams(RequestParams) end
---@param Result boolean
---@param Data FPalRandomIncidentSettings
UBP_PalSupplyIncident_C['Get Setting Table Row'] = function(self, Result, Data) end
---@param IncidentSpawner APalRandomIncidentSpawnerBase
UBP_PalSupplyIncident_C['Get Incident Spawner'] = function(self, IncidentSpawner) end
