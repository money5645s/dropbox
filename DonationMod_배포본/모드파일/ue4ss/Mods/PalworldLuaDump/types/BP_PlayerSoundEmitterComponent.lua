...
local UBP_PlayerSoundEmitterComponent_C = {}
...
UBP_PlayerSoundEmitterComponent_C['カスタムイベント_0'] = function(self, ...) end
...
UBP_PlayerSoundEmitterComponent_C['カスタムイベント_1'] = function(self, Component, Hit) end
