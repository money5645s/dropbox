...
---@field OnUpdateSlot FWBP_PalCharacterScrollList_COnUpdateSlot
---@field OnEmptySlot FWBP_PalCharacterScrollList_COnEmptySlot
---@field OnSlotSynced FWBP_PalCharacterScrollList_COnSlotSynced
local UWBP_PalCharacterScrollList_C = {}

---@param SelfButton UWBP_PalCharacterSlotButtonBase_C
function UWBP_PalCharacterScrollList_C:OnSlotSynced_Internal(SelfButton) end
---@param SlotButton UWBP_PalCharacterSlotButtonBase_C
function UWBP_PalCharacterScrollList_C:OnEmptySlot_Internal(SlotButton) end
---@param SlotButton UWBP_PalCharacterSlotButtonBase_C
function UWBP_PalCharacterScrollList_C:OnUpdateSlot_Binded(SlotButton) end
---@param Widget UWidget
function UWBP_PalCharacterScrollList_C:GetTopFocusTarget(Widget) end
---@param widgets TArray<UWidget>
UWBP_PalCharacterScrollList_C['Get All Children'] = function(self, widgets) end
...
UWBP_PalCharacterScrollList_C['On Right Clicked Internal'] = function(self, buttonBase) end
---@param Widget UWBP_PalCharacterSlotButtonBase_C
...
---@param SlotButton UWBP_PalCharacterSlotButtonBase_C
function UWBP_PalCharacterScrollList_C:OnSlotSynced__DelegateSignature(SlotButton) end
---@param SlotButton UWBP_PalCharacterSlotButtonBase_C
function UWBP_PalCharacterScrollList_C:OnEmptySlot__DelegateSignature(SlotButton) end
---@param SlotButton UWBP_PalCharacterSlotButtonBase_C
function UWBP_PalCharacterScrollList_C:OnUpdateSlot__DelegateSignature(SlotButton) end
