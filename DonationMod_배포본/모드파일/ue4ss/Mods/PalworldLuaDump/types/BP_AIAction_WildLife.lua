...
---@field WanderingMinRadius double
---@field CurrentMoveRequestId FPalAsyncMoveRequestId
---@field LastRequestedGoal FVector
---@field GoalChangeThreshold double
local UBP_AIAction_WildLife_C = {}

---@param Goal FVector
---@param IsValid boolean
function UBP_AIAction_WildLife_C:IsValidFollowMoveGoal(Goal, IsValid) end
function UBP_AIAction_WildLife_C:CancelAsyncFollowMoveIfAny() end
---@param Goal FVector
function UBP_AIAction_WildLife_C:IssueAsyncFollowMove(Goal) end
...
UBP_AIAction_WildLife_C['カスタムイベント_Stack'] = function(self, ...) end
---@param Nest boolean
...
function UBP_AIAction_WildLife_C:OnSightCheckAsyncCompleted(bIncludedPlayer, bIncludedAliveNPC, bIncludedEdibleDeadNPC, InSightCharacters) end
