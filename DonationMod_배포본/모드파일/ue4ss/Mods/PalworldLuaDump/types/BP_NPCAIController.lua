...
---@field DisableDropItem boolean
local ABP_NPCAIController_C = {}
...
ABP_NPCAIController_C['カスタムイベント_0'] = function(self, ID) end
---@param HolderController AController
---@param OtomoPal APalCharacter
ABP_NPCAIController_C['カスタムイベント_4'] = function(self, HolderController, OtomoPal) end
...
ABP_NPCAIController_C['カスタムイベント_1'] = function(self, ...) end
---@param DeadInfo FPalDeadInfo
ABP_NPCAIController_C['カスタムイベント_2'] = function(self, DeadInfo) end
