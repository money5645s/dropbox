...
local ABP_PalCharacterMaterialVolume_C = {}
...
ABP_PalCharacterMaterialVolume_C['Force Update'] = function(self, ...) end
ABP_PalCharacterMaterialVolume_C['Force Off'] = function(self, ...) end
ABP_PalCharacterMaterialVolume_C['Force On'] = function(self, ...) end
ABP_PalCharacterMaterialVolume_C['Force Init'] = function(self, ...) end
