...
---@field CircularThrobber_92 UCircularThrobber
...
---@field ['Death Drop Model'] UPalMapObjectDeathDroppedCharacterModel
---@field DropTimerHandle FTimerHandle
---@field FilteringWaiter UPalWordFilterWaiter
local UWBP_DroppedPalInfoWIdget_C = {}

---@param Waiter UPalWordFilterWaiter
---@param FilteredString FString
function UWBP_DroppedPalInfoWIdget_C:OnCompleteTextFiltering(Waiter, FilteredString) end
---@param IsAwaked boolean
function UWBP_DroppedPalInfoWIdget_C:SetAwakening(IsAwaked) end
---@param bImported boolean
function UWBP_DroppedPalInfoWIdget_C:SetImportedFlag(bImported) end
function UWBP_DroppedPalInfoWIdget_C:DropTimer() end
---@param DeathDropModel UPalMapObjectDeathDroppedCharacterModel
function UWBP_DroppedPalInfoWIdget_C:SetDeathDropTimer(DeathDropModel) end
---@param FavoriteIndex int32
function UWBP_DroppedPalInfoWIdget_C:SetFavorite(FavoriteIndex) end
...
function UWBP_DroppedPalInfoWIdget_C:Construct() end
function UWBP_DroppedPalInfoWIdget_C:OnInitialized() end
function UWBP_DroppedPalInfoWIdget_C:Destruct() end
UWBP_DroppedPalInfoWIdget_C['カスタムイベント'] = function(self, ...) end
