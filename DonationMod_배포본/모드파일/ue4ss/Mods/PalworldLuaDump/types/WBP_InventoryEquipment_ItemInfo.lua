...
---@field CanvasPanelWeight UCanvasPanel
...
---@field Horizontal_KeyGuide_MoveHalf UHorizontalBox
---@field Horizontal_KeyGuide_MoveOne UHorizontalBox
...
---@field Image_ItemIcon_BP UImage
...
---@field SizeBox_MainParam USizeBox
---@field SizeBox_SubParam1 USizeBox
---@field SizeBox_SubParam2 USizeBox
...
---@field WBP_PalKeyGuideIcon_89 UWBP_PalKeyGuideIcon_C
...
---@field WBP_PlayerInputKeyGuideIcon_3 UWBP_PlayerInputKeyGuideIcon_C
---@field WBP_PlayerInputKeyGuideIcon_4 UWBP_PlayerInputKeyGuideIcon_C
---@field WBP_PlayerInputKeyGuideIcon_5 UWBP_PlayerInputKeyGuideIcon_C
---@field WBP_PlayerInputKeyGuideIcon_6 UWBP_PlayerInputKeyGuideIcon_C
...
---@field OnDisplaySlotEmpty FWBP_InventoryEquipment_ItemInfo_COnDisplaySlotEmpty
---@field DefaultMsgID_Use FDataTableRowHandle
---@field UseMsgIDMap_TypeA TMap<EPalItemTypeA, FDataTableRowHandle>
---@field UseMsgIDMap_TypeB TMap<EPalItemTypeB, FDataTableRowHandle>
---@field UseMsgIDMap_StaticItemID TMap<FPalDataTableRowName_ItemData, FDataTableRowHandle>
local UWBP_InventoryEquipment_ItemInfo_C = {}

function UWBP_InventoryEquipment_ItemInfo_C:SetupQuickMoveKeyGuide() end
---@param StaticItemId FName
---@param OutItemUseText FText
function UWBP_InventoryEquipment_ItemInfo_C:GetItemUseText(StaticItemId, OutItemUseText) end
---@param ItemId FName
UWBP_InventoryEquipment_ItemInfo_C['Set Blueprint Icon'] = function(self, ItemId) end
---@param Text FText
...
UWBP_InventoryEquipment_ItemInfo_C['Set Sub Param Regene'] = function(self, FoodData) end
---@param ItemId FName
...
UWBP_InventoryEquipment_ItemInfo_C['Setup Tech Mat Details'] = function(self, TechData, IsMasked) end
---@param technologyName FName
---@param CategoryText FText
UWBP_InventoryEquipment_ItemInfo_C['Get Display Technology Category Name'] = function(self, technologyName, CategoryText) end
---@param technologyName FName
---@param IsMasked boolean
---@param IconTexture UTexture2D
UWBP_InventoryEquipment_ItemInfo_C['Setup by Technology Name'] = function(self, technologyName, IsMasked, IconTexture) end
---@param Slot UPalItemSlot
---@param IsEquipable boolean
UWBP_InventoryEquipment_ItemInfo_C['Is Equipable Item'] = function(self, Slot, IsEquipable) end
---@param Slot UPalItemSlot
...
---@param Text FText
UWBP_InventoryEquipment_ItemInfo_C['Set Simple Additional Text'] = function(self, Text) end
---@param StaticItemId FName
UWBP_InventoryEquipment_ItemInfo_C['Setup Parameter'] = function(self, StaticItemId) end
UWBP_InventoryEquipment_ItemInfo_C['Setup Item Weight'] = function(self, ...) end
function UWBP_InventoryEquipment_ItemInfo_C:SetupItemNum() end
UWBP_InventoryEquipment_ItemInfo_C['Hide Main Parameter'] = function(self, ...) end
---@param StaticItemId FName
function UWBP_InventoryEquipment_ItemInfo_C:SetupItemDescription(StaticItemId) end
---@param ItemStaticId FName
UWBP_InventoryEquipment_ItemInfo_C['Setup Item Name'] = function(self, ItemStaticId) end
---@param ItemId FName
UWBP_InventoryEquipment_ItemInfo_C['Set Pal Gear Icon'] = function(self, ItemId) end
---@param StaticItemId FName
UWBP_InventoryEquipment_ItemInfo_C['Setup Item Icon'] = function(self, StaticItemId) end
...
---@param Text FText
UWBP_InventoryEquipment_ItemInfo_C['Set Main Param Text'] = function(self, Text) end
---@param Value int32
UWBP_InventoryEquipment_ItemInfo_C['Set Main Param Value'] = function(self, Value) end
UWBP_InventoryEquipment_ItemInfo_C['Hide Sub Parameter'] = function(self, ...) end
---@param Text FText
UWBP_InventoryEquipment_ItemInfo_C['Set Sub Param Text'] = function(self, Text) end
---@param DisplayType E_PalUIItemInfoWindowDIsplayType::Type
UWBP_InventoryEquipment_ItemInfo_C['Change Display Mode'] = function(self, DisplayType) end
---@param Value int32
UWBP_InventoryEquipment_ItemInfo_C['Set Sub Param Value'] = function(self, Value) end
...
function UWBP_InventoryEquipment_ItemInfo_C:OnDisplaySlotEmpty__DelegateSignature() end
