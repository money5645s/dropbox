...
local UWBP_PalNPCHPGauge_C = {}

function UWBP_PalNPCHPGauge_C:UpdateStatusEffectDetail() end
function UWBP_PalNPCHPGauge_C:UpdateCompleteCaptureBonus() end
---@param bFriendOrAlly boolean
function UWBP_PalNPCHPGauge_C:CheckFriendOrAlly(bFriendOrAlly) end
---@param PrevSettings FPalOptionUISettings
---@param NewSettings FPalOptionUISettings
UWBP_PalNPCHPGauge_C['On UISettinga Changed'] = function(self, PrevSettings, NewSettings) end
---@param GenderType EPalGenderType
function UWBP_PalNPCHPGauge_C:SetGender(GenderType) end
function UWBP_PalNPCHPGauge_C:OnUpdateTalent_Binded() end
function UWBP_PalNPCHPGauge_C:OnTimer_CheckActor() end
---@param WorkSuitabilities TMap<EPalWorkSuitability, int32>
UWBP_PalNPCHPGauge_C['Set Work Suitability'] = function(self, WorkSuitabilities) end
...
UWBP_PalNPCHPGauge_C['On Update Sanity Binded'] = function(self, nowSanity, nowMaxSanity) end
...
UWBP_PalNPCHPGauge_C['On Update Level Binded'] = function(self, NewLevel) end
...
UWBP_PalNPCHPGauge_C['Update Gauge Type'] = function(self, ...) end
