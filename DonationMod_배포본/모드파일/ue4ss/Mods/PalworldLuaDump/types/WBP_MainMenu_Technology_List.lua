...
---@field SizeBox_BossTech USizeBox
...
---@field BossTech UWBP_MainMenu_Technology_Content_C
local UWBP_MainMenu_Technology_List_C = {}

function UWBP_MainMenu_Technology_List_C:UpdateAllButtonDetail() end
UWBP_MainMenu_Technology_List_C['Update List Active'] = function(self, ...) end
...
UWBP_MainMenu_Technology_List_C['Get Top Focus Target'] = function(self, Target) end
---@param Level int32
UWBP_MainMenu_Technology_List_C['Set Technology Level'] = function(self, Level) end
---@param DisplayTechnologyData FF_PalUITechnologyDataMapContent
UWBP_MainMenu_Technology_List_C['Set Technology Data'] = function(self, DisplayTechnologyData) end
function UWBP_MainMenu_Technology_List_C:BP_OnEntryReleased() end
---@param bIsExpanded boolean
function UWBP_MainMenu_Technology_List_C:BP_OnItemExpansionChanged(bIsExpanded) end
---@param bIsSelected boolean
function UWBP_MainMenu_Technology_List_C:BP_OnItemSelectionChanged(bIsSelected) end
...
function UWBP_MainMenu_Technology_List_C:OnListItemObjectSet(ListItemObject) end
