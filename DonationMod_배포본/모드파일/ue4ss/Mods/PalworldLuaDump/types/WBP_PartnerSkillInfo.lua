...
---@param Ride boolean
UWBP_PartnerSkillInfo_C['Change Ride Key Guide'] = function(self, Ride) end
function UWBP_PartnerSkillInfo_C:Setup() end
---@param ShouldShow boolean
UWBP_PartnerSkillInfo_C['Should Show UI'] = function(self, ShouldShow) end
UWBP_PartnerSkillInfo_C['Check Partner Skill Unlocked Timer'] = function(self, ...) end
...
UWBP_PartnerSkillInfo_C['Show Effect Time'] = function(self, ...) end
...
UWBP_PartnerSkillInfo_C['Update Cool Down Time'] = function(self, Now, Max) end
---@param Now FFixedPoint
---@param Max FFixedPoint
UWBP_PartnerSkillInfo_C['Update Effect Time'] = function(self, Now, Max) end
---@param SkillNameText FText
UWBP_PartnerSkillInfo_C['Get Partner Skill Name Text'] = function(self, SkillNameText) end
