...
---@field PreVisualizeFlag boolean
local UBP_VisualEffect_PalBattleOutline_C = {}

UBP_VisualEffect_PalBattleOutline_C['Should Reset Stencil Value'] = function(self, ...) end
---@param Return_Value boolean
function UBP_VisualEffect_PalBattleOutline_C:ShouldVisualize(Return_Value) end
---@param DeltaTime double
function UBP_VisualEffect_PalBattleOutline_C:ProgressFade(DeltaTime) end
---@param Alpha double
