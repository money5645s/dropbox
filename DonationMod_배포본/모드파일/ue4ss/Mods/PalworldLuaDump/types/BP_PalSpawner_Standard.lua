...
---@field IgnoreGroundRaycast boolean
---@field AIControllerClass TSubclassOf<APalAIController>
---@field WorldTreeAuraPassiveSkillNames TArray<FName>
---@field HasWorldTreeAura boolean
---@field bIsFixSpawnGroup boolean
---@field FixSpawnGroupTime EPalOneDayTimeType
---@field RarePalAble boolean
local ABP_PalSpawner_Standard_C = {}

---@param SelfCharacter APalCharacter
---@param Attacker APalCharacter
function ABP_PalSpawner_Standard_C:OnCapturedWorldTreeAuraPal(SelfCharacter, Attacker) end
---@param ids TArray<FName>
function ABP_PalSpawner_Standard_C:GetLotteriedIDs(ids) end
---@param fixed boolean
function ABP_PalSpawner_Standard_C:IsFixSpawnGroup(fixed) end
function ABP_PalSpawner_Standard_C:ResetLottery() end
---@param Passives TArray<FName>
function ABP_PalSpawner_Standard_C:GetRandomWorldTreePassiveSkill(Passives) end
---@param SpawnCharacter APalCharacter
function ABP_PalSpawner_Standard_C:EnableWorldTreeAura(SpawnCharacter) end
---@param PalActor AActor
function ABP_PalSpawner_Standard_C:SetLocationIgnoreRaycast(PalActor) end
---@return EPalSpawnedCharacterType
function ABP_PalSpawner_Standard_C:GetSpawnerType() end
---@return FName
function ABP_PalSpawner_Standard_C:GetSpawnerName() end
---@return TArray<FPalSpawnerGroupInfo>
function ABP_PalSpawner_Standard_C:GetOriginalSpawnGroupList() end
---@param WorldContextObject UObject
---@return TArray<FPalSpawnerGroupInfo>
function ABP_PalSpawner_Standard_C:GetSpawnGroupList(WorldContextObject) end
...
ABP_PalSpawner_Standard_C['Is Field Boss or Imprisonment Boss Spawner'] = function(self, IsTimer) end
...
ABP_PalSpawner_Standard_C['Lottery and Spawn Reauest'] = function(self, ...) end
---@param Exist boolean
...
---@param ID FPalInstanceID
ABP_PalSpawner_Standard_C['Spawn Delegate'] = function(self, ID) end
...
ABP_PalSpawner_Standard_C['カスタムイベント_0'] = function(self, ...) end
...
---@param Actor AActor
function ABP_PalSpawner_Standard_C:TestDelaySetLocation(Actor) end
function ABP_PalSpawner_Standard_C:RequestLottery() end
