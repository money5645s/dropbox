...
local UBP_Status_CollectItem_C = {}
...
UBP_Status_CollectItem_C['Observe AIAction'] = function(self, ...) end
...
UBP_Status_CollectItem_C['Get Base Camp Action Class'] = function(self, Class) end
---@param Pause boolean
...
UBP_Status_CollectItem_C['Get Name Text Id'] = function(self, SkillNameTextId) end
---@param Result EPalItemOperationResult
function UBP_Status_CollectItem_C:OnAddItem(Result) end
---@param LotteryValue int32
---@param Index int32
UBP_Status_CollectItem_C['Get Lottery Index'] = function(self, LotteryValue, Index) end
---@param Max int32
---@param RandVal int32
function UBP_Status_CollectItem_C:GetRandVal(Max, RandVal) end
---@param IsActive boolean
UBP_Status_CollectItem_C['Is Actor Active'] = function(self, IsActive) end
