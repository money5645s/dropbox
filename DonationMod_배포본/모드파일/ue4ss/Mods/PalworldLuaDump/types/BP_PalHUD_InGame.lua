...
local ABP_PalHUD_InGame_C = {}

---@param PlayerCharacter APalPlayerCharacter
---@param DyingEndInfo FPalDyingEndInfo
function ABP_PalHUD_InGame_C:CREATEDELEGATE_PROXYFUNCTION_0(PlayerCharacter, DyingEndInfo) end
...
ABP_PalHUD_InGame_C['Setup Lift Item Event'] = function(self, ...) end
...
---@param PlayerCharacter APalPlayerCharacter
---@param DyingEndInfo FPalDyingEndInfo
function ABP_PalHUD_InGame_C:OnDyingEnd(PlayerCharacter, DyingEndInfo) end
...
---@param SizeX int32
---@param SizeY int32
function ABP_PalHUD_InGame_C:ReceiveDrawHUD(SizeX, SizeY) end
