...
UWBP_PalItemSlotBase_C['Unbind Event'] = function(self, ...) end
function UWBP_PalItemSlotBase_C:BindEvent() end
---@param Slot UPalItemSlot
UWBP_PalItemSlotBase_C['On Update Slot Internal'] = function(self, Slot) end
