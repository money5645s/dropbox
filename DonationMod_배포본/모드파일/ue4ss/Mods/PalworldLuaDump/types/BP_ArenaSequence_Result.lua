...
---@field OnSetResult FBP_ArenaSequence_Result_COnSetResult
local UBP_ArenaSequence_Result_C = {}

function UBP_ArenaSequence_Result_C:ReleaseCOOPAllPlayer() end
function UBP_ArenaSequence_Result_C:BindRider() end
...
---@param isDisable boolean
UBP_ArenaSequence_Result_C['Set Disable Movement'] = function(self, isDisable) end
...
UBP_ArenaSequence_Result_C['End Process'] = function(self, ...) end
...
function UBP_ArenaSequence_Result_C:OnGetOff(RideActor) end
---@param EntryPoint int32
function UBP_ArenaSequence_Result_C:ExecuteUbergraph_BP_ArenaSequence_Result(EntryPoint) end
function UBP_ArenaSequence_Result_C:OnSetResult__DelegateSignature() end
