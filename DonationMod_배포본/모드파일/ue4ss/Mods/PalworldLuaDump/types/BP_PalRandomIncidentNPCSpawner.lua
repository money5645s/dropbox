...
local ABP_PalRandomIncidentNPCSpawner_C = {}
...
ABP_PalRandomIncidentNPCSpawner_C['Setup Npc Controller'] = function(self, NPCController, SpawnedChara, ID) end
...
---@param ID FPalInstanceID
ABP_PalRandomIncidentNPCSpawner_C['Setup Spawned Character'] = function(self, ID) end
---@param Handle UPalIndividualCharacterHandle
---@return boolean
...
---@param ID FPalInstanceID
---@param PathName FName
ABP_PalRandomIncidentNPCSpawner_C['Get Path Name'] = function(self, ID, PathName) end
---@param ID FPalInstanceID
...
---@param Handle UPalIndividualCharacterHandle
---@param SpawnedLocation FVector
function ABP_PalRandomIncidentNPCSpawner_C:SpawnCharacter(RowName, CharacterID, UniqueName, OtomoName, Level, AIController, PathName, Location, Radius, RotZ, SpawnPointIndex, SpawnPointCount, Handle, SpawnedLocation) end
---@param RowName FName
---@param SpawnData FPalRandomIncidentSpawnNPCData
---@param SpawnPointIndex int32
---@param SpawnPointCount int32
ABP_PalRandomIncidentNPCSpawner_C['Spawn NPC'] = function(self, RowName, SpawnData, SpawnPointIndex, SpawnPointCount) end
---@param RowName FName
---@param SpawnData FPalRandomIncidentSpawnMonsterData
---@param SpawnPointIndex int32
---@param SpawnPointCount int32
ABP_PalRandomIncidentNPCSpawner_C['Spawn Monster'] = function(self, RowName, SpawnData, SpawnPointIndex, SpawnPointCount) end
---@param ID FPalInstanceID
---@param Character APalCharacter
ABP_PalRandomIncidentNPCSpawner_C['Get Character'] = function(self, ID, Character) end
---@param ID FPalInstanceID
---@param Handle UPalIndividualCharacterHandle
...
ABP_PalRandomIncidentNPCSpawner_C['Despawn Characters'] = function(self, ...) end
---@param RowName FName
---@param SpawnData FPalRandomIncidentSpawnMonsterData
---@param SpawnPointIndex int32
---@param SpawnPointCount int32
...
---@param ID FPalInstanceID
ABP_PalRandomIncidentNPCSpawner_C['On Character Spawned '] = function(self, ID) end
---@param InCharacter APalCharacter
ABP_PalRandomIncidentNPCSpawner_C['カスタムイベント_0'] = function(self, InCharacter) end
